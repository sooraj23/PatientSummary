...
namespace PatientSummaryApi.Data
{
    public class PatientRepository : IPatientRepository
    {
        private readonly List<Patient> patients = new() { 
            ...
            new Patient { Id = 2, NHSNumber = "JC6547892CT25", Name = "John Cockram", DateOfBirth = new DateTime(1989, 9, 7), GPPractice = "Northumbria Healthcare clinic" },
            ...
            new Patient { Id = 4, NHSNumber = "LB7982564LD25", Name = "Liam Bibby", DateOfBirth = new DateTime(1985, 7, 16), GPPractice = "Northumbria Healthcare clinic" },
            new Patient { Id = 5, NHSNumber = "AC7456321OT25", Name = "Alastair Campell", DateOfBirth = new DateTime(1979, 4, 1), GPPractice = "Northumbria Healthcare clinic" }
        };
